# Excel File Comparison Tool DocumentationExcel File Comparison Tool Documentation
...
```
1. New Value Type HandlingNew Value Type Handling Add to normalize_value() function:
```
```
...
```
```
2. New Comparison RulesNew Comparison Rules Extend compare_excel_files() function:
```
```
...
```
```
3. Additional Output FormatsAdditional Output Formats Modify the main function:
```
```
...
pass
```
### Error Handling ExpansionError Handling Expansion
...
```
## Maintenance GuidelinesMaintenance Guidelines
...
```
## Modification GuideModification Guide

### 1. Skipping Specific Columns1. Skipping Specific Columns
...
### 2. Skipping Specific Rows2. Skipping Specific Rows
